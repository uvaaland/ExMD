...
void Particle::insertRow(double* posx, double* posy, double* posz, double* velx,
...
void Particle::insertRadius(double* radius) { radius_ = radius; }

void Particle::insertNumberAtoms(int* numberAtoms) {
  numberAtoms_ = numberAtoms;
}

void Particle::setBoundary(double* lowx, double* lowy, double* lowz,
