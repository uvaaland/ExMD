...
///
void Physics::Collisions(int nparticles, Particles &particles, double (*nextpositions)[3], double (*nextvelocities)[3]) {
  ...
  double dp[3],dv[3],p1[3],p2[3],n[3],v1n,v1nnew,v1r[3],v2n,v2nnew,v2r[3];
