...
class Physics {
 public:
    ...
    */
     ...
     *  @param nextpositions 2-D array with particles in rows and predicted *             coordinates in columns.
     *  @param nextvelocities 2-D array with partcles in rows and predicted *             velocity components in columns.
     *  @return void
     */
    ...
    * @return void
    */
    void BoundaryCheck(Particles const &particles);
};
